...
def withdraw():
    ...
    def minus():
        ...
        if(row>0):
            ...
            conn.commit()
            messagebox.showinfo("Information","withdraw successfully")
        else:
            messagebox.showinfo("Information","not valid")
            conn.rollback()
            messagebox.showinfo("Information","transaction fail")
...
def fastcash():
    ...
    def five():
        ...
        if(row>0):
            ...
            messagebox.showinfo("Information","not valid")
            conn.rollback()
            messagebox.showinfo("Information","transaction Failed")
...
def ministate():
    ...
    def showmini():
        if True:
            ...
            lb3 = Label(show,text="withdraw",width=20,bg="white",bd=5).place(x=348,y=50)
...
showbtn = Button(win,text="Update Contact ",width=15,height=1,font="Times 15",relief=RAISED,bd=10,command=conchange).place(x=130,y=240)
